...
public class SysPermissionController {
    ...
    @RequestMapping("TopMenuOne.do")
    public Object TopMenuOne(){

        Result result= sysPermissionService.currentTopMenuOne();
    ...
    @RequestMapping("TopMenuTwo.do")
    public Object TopMenuTwo(){

        Result result= sysPermissionService.currentTopMenuTwo();
